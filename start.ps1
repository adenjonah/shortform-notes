# Windows: right-click → "Run with PowerShell" (or: powershell -ExecutionPolicy Bypass -File start.ps1)
...
Write-Host "> Installing Python 3.12 + reelnotes dependencies (first run takes a minute)..."
